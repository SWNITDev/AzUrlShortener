    ...
    public static class UrlList
    {
        ...
        ClaimsPrincipal principal)
        {
            ...
            try
            {
                ...
                result.UrlList = result.UrlList.Where(p => (p.ErstelltVon == string.Concat(principal.FindFirst(ClaimTypes.GivenName).Value,principal.FindFirst(ClaimTypes.NameIdentifier)))).ToList(); //funktioniert das so?
